...
- **Reference grounding** - "I read `<reference path>` § `<section>` before writing the handler at `<file:line>`, and disclosed it to the user" per `agent_docs/workflow.md` § "Reference Citations".
